...
class PermissionTableSeeder extends Seeder {
	...
	public function run() {
		...
		$permission_model = config('access.permission');
		$deletePermissions = new $permission_model;
		$deletePermissions->name = 'phi_access_management';
		$deletePermissions->display_name = 'PHI Access';
		$deletePermissions->system = true;
		$deletePermissions->group_id = 4;
		...
		$permission_model = config('access.permission');
		$deletePermissions = new $permission_model;
		$deletePermissions->name = 'moh_access_management';
		$deletePermissions->display_name = 'MOH Access';
		$deletePermissions->system = true;
		$deletePermissions->group_id = 4;
